...
async def whatsapp_handler(request: Request) -> Response:
    ...
    if request.method == "GET":
        ...
        if params.get("hub.verify_token").strip() == os.getenv("WHATSAPP_VERIFY_TOKEN").strip():
            return Response(content=params.get("hub.challenge"), status_code=200, media_type="text/html")
        return Response(content=f"Verify Token Mismatch", status_code=403, media_type="text/html")
